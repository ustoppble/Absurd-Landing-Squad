...
export const UPCOMING_MATCHES: UpcomingMatch[] = [
  ...
  },
  {
    ...
    eventName: 'BLAST Premier Spring Groups 2026',
    eventLogo: asset('/graphics/match-event-logo-1.png'),
    format: 'Bo3',
    dateLabel: '20 JUN · 20H00 BRT',
    dateISO: '2026-06-20T20:00:00-03:00',
    microcopy: 'Estreia no BLAST — confronto com o gigante brasileiro',
  },
  {
    id: 'p5',
    opponentName: 'Imperial',
    opponentLogo: asset('/graphics/match-opp-logo-5.png'),
    eventName: 'CCT Americas Season 2 — Semifinal',
    eventLogo: asset('/graphics/match-event-logo-2.png'),
    format: 'Bo3',
    dateLabel: '25 JUN · 19H30 BRT',
    dateISO: '2026-06-25T19:30:00-03:00',
    microcopy: 'Vaga na grande final em disputa — favoritos trocam de lado',
  },
  {
    id: 'p6',
    opponentName: 'Legacy',
    opponentLogo: asset('/graphics/match-opp-logo-2.png'),
    eventName: 'IEM Cologne 2026 Qualifier',
    format: 'Bo1',
    dateLabel: '30 JUN · 17H00 BRT',
    dateISO: '2026-06-30T17:00:00-03:00',
    microcopy: 'Tudo ou nada — ticket pro IEM Cologne vale mais que qualquer troféu',
  },
]
...
export const PAST_MATCHES: PastMatch[] = [
  ...
  },
  {
    ...
    scoreOpp: 1,
    isWin: true,
    microcopy: 'Remontada histórica — 4–11 no primeiro tempo vira 16–14',
    maps: [
      { name: 'Vertigo', scoreOC: 16, scoreOpp: 14, thumb: asset('/graphics/match-map-thumb-1.png') },
      { name: 'Nuke', scoreOC: 11, scoreOpp: 16 },
      { name: 'Mirage', scoreOC: 16, scoreOpp: 10, thumb: asset('/graphics/match-map-thumb-2.png') },
    ],
  },
  {
    id: 'r5',
    opponentName: 'Fluxo',
    opponentLogo: asset('/graphics/match-opp-logo-1.png'),
    eventName: 'CBCS Pro Series 2026 — Grupos',
    format: 'Bo2',
    dateLabel: '12 MAI 2026',
    scoreOC: 1,
    scoreOpp: 1,
    isWin: false,
    microcopy: 'Empate na chave A. Saldo de rounds decide classificação',
    maps: [
      { name: 'Ancient', scoreOC: 16, scoreOpp: 12 },
      { name: 'Inferno', scoreOC: 13, scoreOpp: 16, thumb: asset('/graphics/match-map-thumb-1.png') },
    ],
  },
  {
    id: 'r6',
    opponentName: 'Heroic',
    opponentLogo: asset('/graphics/match-opp-logo-2.png'),
    eventName: 'IEM Dallas 2026 — Play-In',
    format: 'Bo3',
    dateLabel: '05 MAI 2026',
    scoreOC: 0,
    scoreOpp: 2,
    isWin: false,
    microcopy: 'Primeira vez na cena internacional. Experiência valiosa para o time.',
    maps: [
      { name: 'Anubis', scoreOC: 9, scoreOpp: 16, thumb: asset('/graphics/match-map-thumb-2.png') },
      { name: 'Overpass', scoreOC: 12, scoreOpp: 16 },
    ],
  },
]
